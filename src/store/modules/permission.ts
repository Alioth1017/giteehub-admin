...
export const usePermissionStore = defineStore({
  ...
  actions: {
    ...
    async buildRoutesAction(_id?: number | string): Promise<AppRouteRecordRaw[]> {
      const { t } = useI18n();
      ...
      if (permissionMode === PermissionModeEnum.ROLE) {
        ...
        // }
        const permmenu = (await getMenuListById()) as any;
        let routeList = transformPermMenu(permmenu.menus);
        console.log(permmenu.menus, routeList);
